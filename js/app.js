...
if (document.querySelector('.slider-page__body')) {
	...
	new Swiper('.slider-page__body', {
		...
		// Dotts
		pagination: {
			el: '.controls-slider-page__dotts',
			clickable: true,
		},
		// Arrows
		// navigation: {
...
const sliderThumbs = new Swiper('.slider-column__thumbs .slider-column__swiper-container', { // ищем слайдер превью по селектору
	// задаем параметры
...
const sliderImages = new Swiper('.slider-column__images .slider-column__swiper-container', { // ищем слайдер превью по селектору
	// задаем параметры
	effect: 'fade',
	direction: 'vertical', // вертикальная прокрутка
...
window.onload = function () {
	...
	function documentActions(e) {
      ...
      if(document.querySelector('.search-form._active')) {
			document.querySelector('.search-form__icon').classList.add('_hidden')
		} else if (!document.querySelector('.search-form._active')) {
			document.querySelector('.search-form__icon').classList.remove('_hidden')
		}
	}
   ...
   const callback = function (enteries, observer) {
	...
	//  if (targetElement.classList.contains('filter-panel__parent')){
	// 	 targetElement.closest('.catalog__filter-panel').classList.toggle('_active');
	//  }


}

const elems = document.querySelector('.item-product__title');

const textElementContent = elems.innerHTML;

console.log(textElementContent);
elems.innerHTML = `${textSpo}`
'
